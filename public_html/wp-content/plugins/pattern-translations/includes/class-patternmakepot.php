<?php
/**
 * Pattern translation catalog generation.
 *
...
/**
 * Build and import pattern translation catalogs.
 */
class PatternMakepot {
	/**
	 * Patterns included in the catalog.
	 *
	 * @var Pattern[]
	 */
	public $patterns;
	 ...
	 *
	 * @param int|null $revision_time Revision timestamp, or null for the current time.
	 * @return string Exported template.
	 */
	...
	/**
	 * Build a translation catalog.
	 *
	 * @param int|null $revision_time Revision timestamp, or null for the current time.
	 * @return \PO Translation catalog.
	 */
	...
	/**
	 * Collect unique strings and their source references.
	 *
	 * @return array Translation entries.
	 */
	public function entries(): array {
		...
		foreach ( $this->patterns as $pattern ) {
			...
			foreach ( $parser->to_strings() as $string ) {
				...
				if ( ! empty( $pattern->source_url ) && ! in_array( $pattern->source_url, $entries[ $string ]->references, true ) ) {
	...
	/**
	 * Import pattern strings into GlotPress.
	 *
	 * @param bool $save Whether to persist the import.
	 ...
	 *
	 * @param \PO         $po               Imported catalog.
	 * @param \GP_Project $project          GlotPress project.
	 * @param array       $originals_by_key Existing originals keyed by entry key.
	 * @return \PO Updated catalog.
	 */
